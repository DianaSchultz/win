...
-- Tiempo de generación: 04-08-2015 a las 15:09:45
...
(5, 'Dip de espinacas', '(Espinacas con alcachofas, queso crema y totopos).', 65, '', 1, 'imagenes/dip.jpg'),
...
('2-1508031220', 0, 'Dip de espinacas ', 1, 65.00, 65.00),
('2-1508031220', 0, 'Tapas de papa con tocino ', 1, 55.00, 55.00),
('2-1508031220', 0, 'Gajos de papas fritas ', 1, 55.00, 55.00);
...
INSERT INTO `t_orden_total` (`id_orden`, `fk_mesa`, `fk_num_emp`, `fecha_pedido`, `total_pedido`) VALUES
('1', 1, 0, '2015-07-31', 14),
('10', 2, 0, '2015-07-31', 65),
('11', 2, 0, '2015-07-31', 120),
('12', 2, 0, '2015-08-02', 55),
('13', 2, 0, '2015-08-02', 612),
('14', 2, 0, '2015-08-02', 612),
('15', 2, 0, '2015-08-02', 227),
('16', 2, 0, '2015-08-03', 165),
('17', 2, 0, '2015-08-03', 220),
('18', 2, 0, '2015-08-03', 55),
('19', 2, 0, '2015-08-03', 0),
('2', 1, 0, '2015-07-31', 14),
('20', 2, 0, '2015-08-03', 279),
('21', 2, 0, '2015-08-03', 459),
('22', 2, 0, '2015-08-03', 104),
('23', 2, 0, '2015-08-03', 169),
('24', 2, 0, '2015-08-03', 49),
('3', 6, 0, '2015-07-31', 14),
('4', 2, 0, '2015-07-31', 14),
('5', 2, 0, '2015-07-31', 14),
('6', 2, 0, '2015-07-31', 55),
...
--
-- Indices de la tabla `t_orden_total`
--
ALTER TABLE `t_orden_total`
...
--
ALTER TABLE `empleados`
MODIFY `num_emp` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `platillos`
MODIFY `num_platillo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
